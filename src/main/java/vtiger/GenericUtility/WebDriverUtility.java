...
public class WebDriverUtility {
	...
	/**
	 * This method will perform drag and drop from source element location to target
	 * element location
	 * 
	 * @param driver
	 * @param srcElement
	...
	/**
	 * This method will switch from one window to another based on partial window
	 * title
	 * 
	 * @param driver
